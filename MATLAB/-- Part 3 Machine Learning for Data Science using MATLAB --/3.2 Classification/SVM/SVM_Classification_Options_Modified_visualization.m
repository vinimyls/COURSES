...
%classification_model_1 = fitcsvm(data,'Purchased~Age+EstimatedSalary','KernelFunction','gaussian');
%classification_model_1 = fitcsvm(data,'Purchased~Age+EstimatedSalary','OutlierFraction',0.1);

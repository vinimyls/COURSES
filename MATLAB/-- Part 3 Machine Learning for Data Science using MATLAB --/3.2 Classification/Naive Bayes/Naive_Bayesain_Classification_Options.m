...
classification_model_1 = fitcnb(data,'Purchased~Age+EstimatedSalary', 'Distribution', 'kernel');
%classification_model_1 = fitcnb(data,'Purchased~Age+EstimatedSalary', 'Distribution', 'mn');
%classification_model_1 = fitcnb(data,'Purchased~Age+EstimatedSalary', 'Distribution', 'normal');
%classification_model_1 = fitcnb(data,'Purchased~Age+EstimatedSalary', 'Distribution', 'mvmn');
%classification_model_1 = fitcnb(data,'Purchased~Age+EstimatedSalary', 'DistributionNames', {'kernel', 'kernel}');
% Please consult the video lectures for complete options
...
classifier_name = 'Naive Bayesain (Default options)';
...
labels = unique(data.Purchased);
classifier_name = 'Naive Bayesain (Modified options)';
